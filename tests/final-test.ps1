# Final Laravel + React Flash Cards API Integration Test
#
# Purpose: Comprehensive end-to-end testing of the Laravel API backend
...
# - Card state management (known/unknown toggles)
# - API response validation
# - Integration between React frontend and Laravel backend
#
